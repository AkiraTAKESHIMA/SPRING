...
def make_rt(cnf, step, 
            srcMeshNameFmt, tgtMeshNameFmt, lst_landType,
...
def run():
    ...
    make_rt(cnf, step, 
            'MATSIRO_latlon_{landType}', 'CaMa-Flood_latlon_{landType}',
            ['river'],
    ...
    # *** Values of "area.bin" is incorrect but not used for remapping
    make_rt(cnf, step, 
            'CaMa-Flood_latlon_{landType}', 'MATSIRO_latlon_{landType}',
            ['river'],
    ...
    # *** Verification data for source grid is incorrect
    make_rt(cnf, step, 
            'CaMa-Flood_latlon_{landType}', 'IO_CaMa-Flood_row_{landType}',
            ['river'],
