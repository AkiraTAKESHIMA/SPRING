module common_rt_main_driv
  ...
  ! Public Proceduers
  !-------------------------------------------------------------
  public :: output_rt_main_no_im
  public :: output_rt_main_from_im
  !-------------------------------------------------------------
contains
!===============================================================
!
...
subroutine output_rt_main_no_im(&
  ...
  call echo(code%bgn, 'output_rt_main_no_im')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
  rtm => rt%main
...
subroutine output_rt_main_from_im(&
  ...
  call echo(code%bgn, 'output_rt_main_from_im')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
  rtm => rt%main
  ...
  ! Case: Total length exceeds the ulim.
    ...
    ! Make tmp data
    !-----------------------------------------------------------
    call echo(code%ent, 'Making tmp data')
...
!
!===============================================================
end module common_rt_main_driv
