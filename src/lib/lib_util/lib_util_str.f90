module lib_util_str
  ...
  !
  !-------------------------------------------------------------
  character(CLEN_PROC), parameter :: MODNAM = 'lib_util_str'
  !-------------------------------------------------------------
contains
!===============================================================
!
...
function str_bgn_sentence(s) result(sout)
  implicit none
  character(CLEN_PROC), parameter :: PRCNAM = 'str_bgn_sentence'
...
!
!===============================================================
function str_coords_1d(&
    coords, coef, miss, wfmt, dlm, n1max) result(res)
  implicit none
  character(CLEN_PROC), parameter :: PRCNAM = 'str_coords_1d'
