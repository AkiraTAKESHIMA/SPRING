...
subroutine set_wfmt_real(wfmt)
  implicit none
  character(CLEN_PROC), parameter :: PRCNAM = 'set_wfmt_real'
...
character(CLEN_WFMT) function get_wfmt_real() result(wfmt)
  implicit none
  character(CLEN_PROC), parameter :: PRCNAM = 'get_wfmt_real'
...
subroutine init_wfmt_real()
  implicit none
  character(CLEN_PROC), parameter :: PRCNAM = 'init_wfmt_real'
