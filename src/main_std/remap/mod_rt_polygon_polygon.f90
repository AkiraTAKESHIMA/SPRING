...
!
!===============================================================
subroutine make_rt_polygon_polygon(s, t, rt, regions, opt)
  implicit none
...
!    call calc_rt_im_nij_ulim(rt%im%nij_ulim, s, t, opt%sys%memory_ulim)
  ...
  do iRegion = 1, regions%nRegions
    ...
    do ttij = 1_8, region%mtij
      ...
      do ssij = 1_8, region%msij
        ...
        sarea = sgp%grid%ara(sij) / opt%earth%r**2
