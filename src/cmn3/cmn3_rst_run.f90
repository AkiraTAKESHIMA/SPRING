module cmn3_rst_run
  ...
  !-------------------------------------------------------------
  character(CLEN_VAR) :: MODNAME = 'cmn3_rst_run'
...
integer function init_is_ok(stat)
  ...
  call echo(code%bgn, trim(MODNAME)//' init_is_ok', '-p -x2')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
  init_is_ok = 0
...
integer function finalize() result(info)
  ...
  call echo(code%bgn, trim(MODNAME)//' finalize', '-p -x2')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
  info = 0
...
subroutine initialize_zone(&
  ...
  call echo(code%bgn, trim(MODNAME)//' initialize_zone', '-p -x2')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
  bzhi = bhi
...
subroutine get_tasks(&
  ...
  call echo(code%bgn, trim(MODNAME)//' get_tasks', '-p -x2')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
...
subroutine alloc_map__iarea_max(map)
  ...
  call echo(code%bgn, trim(MODNAME)//' alloc_map__iarea_max', '-p -x2')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
  allocate(map(bzhi:bzhf,bzvi:bzvf))
...
subroutine update_iarea_max(&
  ...
  call echo(code%bgn, trim(MODNAME)//' update_iarea_max', '-p -x2')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
  do idv = dvi, dvf
...
subroutine make_idx(&
  ...
  call echo(code%bgn, TRIM(MODNAME)//' make_idx', '-p -x2')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
...
subroutine make_mask(mask, iratio_sum)
  ...
  call echo(code%bgn, trim(MODNAME)//' make_mask', '-p -x2')
  !-------------------------------------------------------------
  !
  !-------------------------------------------------------------
