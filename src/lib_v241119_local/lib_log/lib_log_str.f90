...
function str_int1_1d_min_nodlm(x) result(c)
  ...
  integer :: l, ll
  integer :: i
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int1_1d_min_nodlm ***'

  selectcase( size(x) )
  case( :0 )
    write(0,"(a)") trim(err_proc)
    write(0,"(a)") 'Size of array is invalid.'
    stop
  case( 1 )
    write(c,"(i0)") x(1)
  case( 2: )
...
function str_int1_1d_min_dlm(x, dlm) result(c)
  ...
  integer :: l, ll, l_dlm
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int1_1d_min_dlm ***'
...
function str_int1_1d_fmt_nodlm(x, d) result(c)
  ...
  integer :: l, ll
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int1_1d_fmt_nodlm ***'
...
function str_int1_1d_fmt_dlm(x, d, dlm) result(c)
  ...
  integer :: l, ll, l_dlm
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int1_1d_fmt_dlm ***'
...
function str_int2_1d_min_nodlm(x) result(c)
  ...
  integer :: i
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int2_1d_min_nodlm ***'
...
function str_int2_1d_min_dlm(x, dlm) result(c)
  ...
  integer :: l, ll, l_dlm
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int2_1d_min_dlm ***'
...
function str_int2_1d_fmt_nodlm(x, d) result(c)
  ...
  integer :: l, ll
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int2_1d_fmt_nodlm ***'
...
function str_int2_1d_fmt_dlm(x, d, dlm) result(c)
  ...
  integer :: l, ll, l_dlm
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int2_1d_fmt_dlm ***'
...
function str_int4_1d_min_nodlm(x) result(c)
  ...
  integer :: i
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int4_1d_min_nodlm ***'
...
function str_int4_1d_min_dlm(x, dlm) result(c)
  ...
  integer :: l, ll, l_dlm
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int4_1d_min_dlm ***'
...
function str_int4_1d_fmt_nodlm(x, d) result(c)
  ...
  integer :: l, ll
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int4_1d_fmt_nodlm ***'
...
function str_int4_1d_fmt_dlm(x, d, dlm) result(c)
  ...
  integer :: l, ll, l_dlm
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int4_1d_fmt_dlm ***'
...
function str_int8_1d_min_nodlm(x) result(c)
  ...
  integer :: i
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int8_1d_min_nodlm ***'
...
function str_int8_1d_min_dlm(x, dlm) result(c)
  ...
  integer :: l, ll, l_dlm
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int8_1d_min_dlm ***'
...
function str_int8_1d_fmt_nodlm(x, d) result(c)
  ...
  integer :: l, ll
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int8_1d_fmt_nodlm ***'
...
function str_int8_1d_fmt_dlm(x, d, dlm) result(c)
  ...
  integer :: l, ll, l_dlm
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_int8_1d_fmt_dlm ***'
...
function str_real_1d_nofmt_nodlm(x) result(c)
  ...
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_real_1d_nofmt_nodlm ***'
...
function str_real_1d_fmt_nodlm(x, fmt) result(c)
  ...
  character(CLEN_WFMT) :: wfmt
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_real_1d_fmt_nodlm ***'
...
function str_real_1d_fmt_dlm(x, fmt, dlm) result(c)
  ...
  character(CLEN_WFMT) :: wfmt
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_real_1d_fmt_dlm ***'
...
function str_dble_1d_nofmt_nodlm(x) result(c)
  ...
  character(CLEN_WFMT) :: wfmt
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_dble_1d_nofmt_nodlm ***'
...
function str_dble_1d_fmt_nodlm(x, fmt) result(c)
  ...
  character(CLEN_WFMT) :: wfmt
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_dble_1d_fmt_nodlm ***'
...
function str_dble_1d_fmt_dlm(x, fmt, dlm) result(c)
  ...
  character(CLEN_WFMT) :: wfmt
  character(CLEN_MSG), parameter :: err_proc = &
    '*** ERROR @ MODULE lib_log_str SUBROUTINE str_dble_1d_fmt_dlm ***'
