...
#
#===============================================================
srcGridName="io-metnc"
tgtGridName="mat"

f_report_river="../tmp/01_make_rt/${srcGridName}_to_${tgtGridName}-river/report.txt"
f_report_noriv="../tmp/01_make_rt/${srcGridName}_to_${tgtGridName}-noriv/report.txt"
...
[input]
  ...
  dir: "../tmp/01_make_rt/${srcGridName}_to_${tgtGridName}-river"
  ...
  dir: "../tmp/01_make_rt/${srcGridName}_to_${tgtGridName}-noriv"
  f_rt_sidx: "grid.bin", int4, 1, big
  f_rt_tidx: "grid.bin", int4, 2, big
  f_rt_area: "area.bin", dble, 1, big
  f_rt_coef: "coef.bin", dble, 1, big
