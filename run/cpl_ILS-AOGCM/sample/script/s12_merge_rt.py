...
\n\
  ...
  f_rt_sidx: "grid.bin", {dtype}, 1, {dtype}\n\
  f_rt_tidx: "grid.bin", {dtype}, 2, {dtype}\n\
  f_rt_area: "area.bin", dble, 1, {dtype}\n\
  f_rt_coef: "coef.bin", dble, 1, {dtype}\n\
[end]\n'
...
def merge_rt(srcMeshNameFmt, tgtMeshNameFmt, lst_landType, pdir_in, grid_coef):
    ...
    runname = f'rt_{get_meshBaseName(srcMeshName)}_to_{get_meshBaseName(tgtMeshName)}'
    ...
    f_log = f'{lconst.dir_log[step]}/{runname}.err'
