...
#
#===============================================================
f_conf="${dir_set_step}/merge_rt_lsm-noriv_to_ogcm_via_agcm.conf"
dir_tmp_this="${dir_tmp_step}/rt_lsm-noriv_to_ogcm_via_agcm"

dir_in_noriv_real="${dir_tmp}/${name_step_11}/rt_lsm-noriv-real_to_ogcm_via_agcm"
dir_in_noriv_virt="${dir_tmp}/${name_step_11}/rt_lsm-noriv-virt_to_ogcm_via_agcm"

for dir_in in "${dir_in_noriv_real}" "${dir_in_noriv_virt}"; do
