...
#
#===============================================================
f_conf="${dir_set_step}/merge_rt_io-met_to_lsm.conf"
dir_tmp_this="${dir_tmp_step}/rt_io-met_to_lsm"

dir_in_river="${dir_tmp}/${name_step_10}/rt_io-met_to_lsm-river"
dir_in_noriv_real="${dir_tmp}/${name_step_10}/rt_io-met_to_lsm-noriv-real"
dir_in_noriv_virt="${dir_tmp}/${name_step_10}/rt_io-met_to_lsm-noriv-virt"
