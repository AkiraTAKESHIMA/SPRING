...
#
#===============================================================
f_conf="${dir_set_step}/merge_rt_lsm_to_io-rect.conf"
dir_tmp_this="${dir_tmp_step}/rt_lsm_to_io-rect"

dir_in_river="${dir_tmp}/${name_step_10}/rt_lsm-river_to_io-rect"
dir_in_noriv_real="${dir_tmp}/${name_step_10}/rt_lsm-noriv-real_to_io-rect"
dir_in_noriv_virt="${dir_tmp}/${name_step_10}/rt_lsm-noriv-virt_to_io-rect"
