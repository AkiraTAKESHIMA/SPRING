...
#
#===============================================================
dir_tmp_step="${dir_tmp}/${name_step_09}"
dir_set_step="${dir_set}/${name_step_09}"
...
for landType in "river" "noriv-real" "noriv-virt"; do
  f_conf="${dir_set_step}/make_grid_data_lsm_${landType}.conf"
...
EOF
  ...
  cp -f ../tmp/${name_step_08}/lsm/grdidx_${landType}.bin ${dir_tmp_this}/.
  cp -f ../tmp/${name_step_08}/lsm/grdara_${landType}.bin ${dir_tmp_this}/.
done
