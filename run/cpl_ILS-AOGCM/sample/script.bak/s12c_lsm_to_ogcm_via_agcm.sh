...
#
#===============================================================
f_conf="${dir_set_step}/merge_rt_lsm_to_ogcm_via_agcm.conf"
dir_tmp_this="${dir_tmp_step}/rt_lsm_to_ogcm_via_agcm"

dir_in_river="${dir_tmp}/${name_step_11}/rt_lsm-river_to_ogcm_via_agcm"
