module lib_math_exception
  ...
  !-------------------------------------------------------------
  character(CLEN_PROC), parameter :: MODNAM = 'lib_math_exception'
  !-------------------------------------------------------------
contains
!===============================================================
!
...
logical function is_nan__condition_dble_1d(x, condition) result(res)
  implicit none
  character(CLEN_PROC), parameter :: PRCNAM = 'is_nan__condition_dble_1d'
  real(8), intent(in) :: x(:)
  ...
  case( 'any' )
    ...
    enddo
  case default
    call errend(msg_invalid_value('condition', condition))
  endselect
  !-------------------------------------------------------------
...
logical function is_nan__condition_dble_2d(x, condition) result(res)
  implicit none
  character(CLEN_PROC), parameter :: PRCNAM = 'is_nan__condition_dble_2d'
  real(8), intent(in) :: x(:,:)
  character(*), intent(in) :: condition
